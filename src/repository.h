...
PyObject* Repository_create_commit(Repository *self, PyObject *args, PyObject *kwds);
PyObject* Repository_amend_commit(Repository *self, PyObject *args, PyObject *kwds);
